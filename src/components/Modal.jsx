          ...
          >
            ...
            <div className="flex justify-end space-x-4">
              <a
                ...
                className="rounded-md bg-gradient-to-r from-[#850e35] to-[#ee6983] px-4 py-2 font-medium text-white hover:from-[#7c3aed] hover:to-[#d946ef] transition-all duration-200"
              >
