...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/silfa-salsa-bila-putri-526453343",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Silfa.sbp",
    icon: Instagram,
    url: "https://www.instagram.com/silfa.sbp?igsh=cGkzZGNhaWRkb29l",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Silfa",
    icon: Github,
    url: "https://github.com/SilfaSalsaBilaPutri",
    color: "#ffffff",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3
        ...
        data-aos="fade-down"
      >
        <span className="inline-block w-8 h-1 bg-[#850e35] rounded-full"></span>
        Connect With Me
      </h3>
